...
public class LevelManager : MonoBehaviour
{
    ...
    public float tempDmg = 0;
    public float tempRt = 0;
    public float tempXPM = 0;
    public float tempTurretDmg = 0;
    public float tempArrowSpeed = 0;
    public float tempChc = 0;
    public float tempChd = 0;
    ...
    private void ResetAppliedUpgrades()
    {
        if (balInstance != null)
        {
            ...
            // **StatManager에도 적용하여 UI가 초기화되도록 설정**
